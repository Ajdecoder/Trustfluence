  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/rate_influencer",
        {
          video_id: youtubeURL,
        }
      );
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Get comprehensive analytics on any YouTube influencer. Enter a
                video or channel URL to analyze content quality, credibility
                score, fraud detection, and overall rating.
              </p>
            </div>
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm">
                    {feature === "📈 Content Quality" &&
                      "Detailed analysis of video content quality and engagement"}
                    {feature === "🛡️ Credibility" &&
                      "Evaluate creator credibility and audience trust metrics"}
                    {feature === "🔍 Fraud Detection" &&
                      "Advanced detection of suspicious activity and fake engagement"}
                  </p>
                </motion.div>
              ))}
            </div>
                  ...
                  <div className="relative z-10">
                    ...
                    {metric.title === "Fraud Score" && (
                      <div className="mt-2 text-sm">
                        {data.fraud_score > 0.99 && (
                          <span className="text-red-200">🚩 Spam Detected</span>
                        )}
                        {data.fraud_score === 0 && (
            ...
            {data.fraud_score > 0.99 && (
              ...
              >
                ...
                <p className="text-red-100">
                  🚨 Alert: This influencer has been flagged as a potential spam
                  account.
                </p>
              </motion.div>
            )}
